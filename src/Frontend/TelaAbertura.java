...
public class TelaAbertura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ImagemAbertura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/sTOCK.png"))); // NOI18N
        ...
        BotaoSignIn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotaoSignInActionPerformed(evt);
            }
        });
    ...
    private void BotaoSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoSignInActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_BotaoSignInActionPerformed
